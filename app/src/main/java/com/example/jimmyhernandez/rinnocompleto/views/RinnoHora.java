...
public class RinnoHora extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rinno_hora);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent miIntent = new Intent(RinnoHora.this,RinnoTweets.class);
                RinnoHora.this.startActivity(miIntent);
                RinnoHora.this.finish();
            }
        }, SPLASH_TIME);
